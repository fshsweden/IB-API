...
import ib.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	/*
	 * Changed m_orderHandlers to contain a LIST of handlers, since it si possible that we have multiple ones "alive" against the same order id!
